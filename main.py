"""Основной модуль програмы. Запускает вводную часть игры."""
...
def attack(char_name: str, char_class: str) -> str:
    """Выводит на экран нанесеный противнику урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит на экран блокированный урон."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит на экран применнное умение."""
    if char_class == 'warrior':
        return (
